...
def interpret(image_encoder, text_encoder, logit_scale, image, concepts, device, start_layer=start_layer, start_layer_text=start_layer_text):
    ...
    text_features = text_encoder(concepts)
    ...
    image_attn_blocks = list(dict(image_encoder.visual.transformer.resblocks.named_children()).values())
